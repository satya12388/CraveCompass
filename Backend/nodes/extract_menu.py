    ...
    response = model.invoke([
        {
            ...
            "content": (
                ...
                "You MUST use exactly this structure and these keys and values(like category should be one of mentioned values):\n"
                "{\n"
                "  \"items\": [\n"
                "    {\n"
                "      \"name\": \"Item Name\",\n"
                "      \"price\": 10.99,\n"
                "      \"category\": \"Veg\" // MUST BE EXACTLY ONE OF: 'Veg', 'Non-Veg', 'Beverages', 'Desserts', or 'Others'. If it is a Snack, Breakfast, Indian Bread, or ambiguous, you MUST classify it as 'Others'.\n"
                "    }\n"
                "  ]\n"
                "}\n"
            )
